...
class WinnerPage extends StatelessWidget {
  /// Constructor
  const WinnerPage({super.key, required this.level});

  /// Current finished level
  final Level level;
  ...
  Widget build(BuildContext context) {
    ...
    switch (level.value) {
      case 1:
        nombreNivel = 'Primer Nivel';
        estadoNivel = 'Tienes el Segundo Nivel desbloqueado';
        break;
      case 2:
        nombreNivel = 'Segundo Nivel';
        estadoNivel = 'Tienes el Tercer Nivel desbloqueado';
        break;
      case 3:
        nombreNivel = 'Tercer Nivel';
        estadoNivel = 'Tienes un Cuarto Nivel desbloqueado';
        break;
      case 4:
        nombreNivel = 'Cuarto Nivel';
        estadoNivel = 'Has completado todos los niveles';
        break;
    }
